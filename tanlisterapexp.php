...
if(!empty($_POST['irsal'])) {
 ...
 ?>
       ...
       <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> تقرير الخبير </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        { 
						   ...
						   echo '<td>';
                           echo (
                             "<div class=\"btn btn-default\" align=\"center\" ><a href=\"tanrapexp.php?idtan=".$val['idtan']."\">تاريخ تقرير الخبير</a></div>\n") ;
                           echo '</td>'; 
    					   echo "</tr>"; 
						  }
						   ?>
