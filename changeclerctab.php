...
<body  style="font-family:tahoma;">
    ...
    <div id="wrapper">
       ...
       <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> تغيير الكاتب  </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                        ...
                        <div class="col-lg-3"> 
                            <label>ادخل  المرجع </label>

                          <input type="text" name="marji3" class="form-control" >

                            </div>
                            <div class="col-lg-3"> 
                            <label>ادخل  اسم  الكاتب  </label>

                          <input type="text" name="new_clerc" class="form-control" >
                            ...
                            <div class="col-lg-3">
                             ...
                             <input type="submit" name="envoyer" value="تغيير الكاتب " class="btn btn-success btn-lg" style="margin:15px; width:50%"  >
...
if(isset($_POST['envoyer'])){
    ...
    $marji3 = $_POST['marji3'];
    $new_clerc = $_POST['new_clerc'];
 
    
            $query = "UPDATE tabligh SET tabclerc='$new_clerc' WHERE idtab = '$marji3'";
            mysqli_query($conn,$query);
            
              
        }
     
          header('Location: changeclerctab.php');
