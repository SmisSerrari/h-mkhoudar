...
if(isset($_POST['filter'])){
    ...
    $tabclerc = isset($_POST['tabclerc']);
    $query1 =mysqli_query($conn,"SELECT tabclerc,COUNT(*),tabreqGen, SUM(tabnote) AS tabnote FROM tabligh WHERE tabclerc = '$tabclerc' AND tabdatetabligh BETWEEN '$from_date' AND '$to_date' GROUP BY tabreqGen ");
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3>احصائيات الكتاب  حسب الملاحظات</h3>
                        </div>
                        <!-- /.panel-heading -->
