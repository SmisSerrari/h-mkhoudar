                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="col-lg-3">
                             ...
                             <input type="submit" name="pdf_print" class="btn btn-danger btn-lg" value="طبع الاجراءات" style="margin:15px; width:80%">
                        ...
                        $NbrCol = 100000;
                        // requête
                        $query = 'SELECT * FROM tabligh WHERE encour=1 and tabdatetabligh!=0 ORDER BY tabdatetabligh DESC LIMIT 20';
                        ...
                        ?> 
                            ...
                            </div><input type="button" onClick="imprimer('sectionAimprimer')" value="print table">
                            <!-- /.list-group -->
                        </div>
                        <!-- /.panel-body -->
                    </div>
            ...
            <div class="row">
                       ...
                       // $query1 = 'SELECT COUNT(*) as idtab FROM tablighat';
                        ...
                        ?>
                            ...
                            </div></div><button class="btn-default" onClick="imprimer('sectionAimprimer1')">طبع </button>
                            <!-- /.row -->
        </form></div>
        <!-- /#page-wrapper -->
