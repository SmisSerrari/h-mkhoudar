            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        $NbrCol = 100000;
                        // requête
                        $query = 'SELECT * FROM tabligh WHERE donne!=1';
                        $result = mysqli_query($conn,$query);;
                        // -------------------------------------------------------      
                        ...
                        echo '<tr class="info">';
                           ...
                           if(($val['tabgenre']=="جلسة") || ($val['tabgenre']=="إعذار")){
                           ...
                           else if($val['tabgenre']=="بيوعات عقارية" ){
                           echo '<td>';

                           echo "72 ساعة <br/>";
                           $datev = $val['tabdatejalsa'];
                           $dateM1 = date('Y-m-d', strtotime($datev.'-30 days'));
                            $dateM2 = date('Y-m-d', strtotime($datev.'-20 days'));
                            $dateM3 = date('Y-m-d', strtotime($datev.'-10 days'));
                            echo("الأجل  1 <br/>");
                            echo "من &nbsp;";
                            echo $dateM1;
                            echo "&nbsp;إلى &nbsp;";
 ...
 if(!empty($_POST['donne'])) {
    $counter = 0;
        ...
        $counter = $counter+1;
            ...
            $query = "UPDATE tabligh SET donne=1 WHERE idtab = $value";
            mysqli_query($conn,$query);
            $query2 = "UPDATE tabligh SET num_donne=NOW() WHERE idtab = $value";
