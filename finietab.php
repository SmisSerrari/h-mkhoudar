...
<form method="post">
       ...
       <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">اجراءات قصد التضمين </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th><input type="checkbox" class="chekckall"></th>
                                            <th>المرجع</th>
                                            <th>المحكمة</th>
                                            <th> نوع الاجراء</th>
                                            <th>رقم الملف</th>
                        ...
                        // requête
                        $query = 'SELECT * FROM tabligh WHERE encour=1 AND monjaz=0';
                        ...
                        { 
						   ...
						   echo '<td>';
                           echo (
                             "<div class=\"btn btn-default\" align=\"center\" ><a href=\"tadmintabligh.php?idtab=".$val['idtab']."\"> تضمين</a></div>\n") ;
                           echo '</td>';                                    
 ...
 if(!empty($_POST['encour'])) {
    $counter = 0;
        ...
        $counter = $counter+1;
            ...
            $query = "UPDATE tabligh SET encour=0 WHERE idtab = $value";
            mysqli_query($conn,$query);
            $query2 = "UPDATE tabligh SET num_encour=0 WHERE idtab = $value";
            mysqli_query($conn,$query2);
              
        }
        $num_encour =  $num_encour + 1;

          header('Location: encourtab.php?counter='.$counter.'');
