    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">مكنب المفوض القضائي الاستاذ </a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        $NbrCol = 100000;
                        // requête
                        $query = 'SELECT * FROM mokhtalif WHERE donne=1 AND encour=0';
                        ...
                        { 
						  echo '<tr class="success">';
						   ...
						   echo '<td>';
						   echo '<input type="checkbox" name="encour[]" value="'.$val['idm'].'"/>';echo '</td>';
 ...
 if(!empty($_POST['encour'])) {
    $counter = 0;
        ...
        $counter = $counter+1;
            ...
            $query = "UPDATE mokhtalif SET encour=1 WHERE idm = $value";
            mysqli_query($conn,$query);
            $query2 = "UPDATE mokhtalif SET num_encour=NOW() WHERE idm = $value";
