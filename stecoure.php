...
$sql = "SELECT * FROM societe WHERE donne = 1 ORDER BY UNIX_TIMESTAMP(num_donne) DESC LIMIT ".$counter."";
...
<body  style="font-family:tahoma;">
    ...
    <div id="wrapper">
       ...
       <div id="page-wrapper">
       <form method="post" action="societe_pdf.php?counter=<?php echo $counter ?>" target="_blank">
            <div class="row">
                <div class="col-lg-12">
