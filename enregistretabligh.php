...
<body style="font-family:tahoma;">
    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="enregistretabligh.php"> تسجيل الاجراءات  المبلغة</a>
                                </li>
                                <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">تسجيل الاجراءات المبلغة</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                                    ...
                                    <div class="form-group">
										...
										<div class="form-group">
                                            <label>نوع الاجراء</label>
                                                ...
                                                <option value="تبليغ عرض عيني">تبليغ عرض عيني</option>
												</select>
                            </div>
							</div>
                            <div class="col-md-3">
                                    <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" required placeholder="2019/02/20" name="tabdateentre">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                <div class="col-md-4">
									<div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="رقم الملف" name="tabnumdoss">
                                        </div>
									</div>
                                    <div class="col-md-4">
                                    <div class="form-group" >
                                ...
                                <div class="col-md-4">
									<div class="form-group">
                                            ...
                                            <input class="form-control" type="date" placeholder="2019/02/20" name="tabdatejalsa">
                                        </div>
									</div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
									<div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="طالب الاجراء" name="tabavec">
                                        </div>
									</div>
                                <div class="col-md-6">
									<div class="form-group">
                                            <label>النائب عنه</label>
                                            <input class="form-control" name="tabavoca" autofocus >
							...
							<div class="row">
                                <div class="col-md-3">
                                        <div class="form-group" style="margin-right:15px">
                                            ...
                                            <select class="form-control" name="tabreqGen" required>
                                                <option ></option>
                                                ...
                                                <option value="خارج الأجل">خارج الأجل</option>
                                                <option value="توقف الإجراء">توقف الإجراء</option>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="date" name="tabdatetabligh" class="form-control" required>
                            ...
                            <div class="col-md-6">
                                    <div class="form-group" style="margin-left:15px">
                                            ...
                                            <textarea class="form-control" rows="2" name="tabreqEcr" required></textarea>
                                        </div>
                                    </div>
                            </div>                  
...
if($tabreqGen=="بلغ"){
    ...
    }else if(($tabreqGen=="مجهول بالعنوان")|| ($tabreqGen=="انتقل من العنوان")|| ($tabreqGen=="العنوان ناقض")|| ($tabreqGen=="لم يعثر على العنوان")|| ($tabreqGen=="مغلق باستمرار")){
...
$query = "INSERT INTO tabligh ( tabtrubunal, tabdateentre, tabregGen, tabregPre, tabgenre, tabnumdoss, tabnumtanfid, tabdatejalsa, tabavec, tabavoca, tabcontre, tabadress, tabsource, tabhuis, tabclerc, donne, encour, tabreqGen, tabdatetabligh, tabreqEcr,tabnote )
            VALUES ( '$tabtrubunal' , '$tabdateentre', '$tabregGen' , '$tabregPre' , '$tabgenre' , '$tabnumdoss' ,'$tabnumtanfid' , '$tabdatejalsa', '$tabavec' , '$tabavoca' , '$tabcontre', '$tabadress', '$tabsource','$tabhuis' , '$tabclerc' ,'$donne' , '$encour' , '$tabreqGen', '$new_date','$tabreqEcr','$tabnote') ";
