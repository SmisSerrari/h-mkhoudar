...
$sql = "SELECT * FROM tanfid  WHERE donne = 1 ORDER BY UNIX_TIMESTAMP(num_donne) DESC LIMIT ".$counter."";
...
$tbl .= "<td width=\"60\" align=\"center\"> ".$val["tangenre"]." </td>";
$tbl .= "<td width=\"110\" align=\"center\"> ".$val["tannumdoss"]." </td>"; 
$tbl .= "<td width=\"90\" align=\"center\"> ".$val["tanavec"]." </td>";  
$tbl .= "<td width=\"90\" align=\"center\"> ".$val["tancontre"]." </td>";
$tbl .= "<td width=\"155\" align=\"center\"> ".$val["tanadress"]." </td>";
$tbl .= "<td width=\"70\" align=\"center\"> ".$val["tanclerc"]." </td>"; 
