                        ...
                        <div class="panel-body">
							...
							<div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="date" name="mkhdatet" class="form-control">
                            ...
                            <div class="col-md-6">
								<div class="form-group" style="margin-left:15px">
                                       <label>الملاحظة الخطية</label>
                                            <textarea class="form-control" rows="2" name="mkhreqecr" ></textarea>
                                        </div>
									</div>
                            </div>					
...
$mkhreqgen = $_POST['mkhreqgen'];
$mkhdatet = strtotime($_POST['mkhdatet']);
$new_date = date('Y-m-d', $mkhdatet);
$mkhreqecr = $_POST['mkhreqecr'];

$sql = "UPDATE moukhtalif SET mkhdatet = '$new_date', mkhreqgen = '$mkhreqgen', mkhreqecr = '$mkhreqecr' WHERE idmkh='$idmkh'";
