                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" >
                                <div class="form-group" style="margin-right:15px">
                                        <label>تاريخ البيع  2 </label>
                                    <input type="date" name="tandatevente1" class="form-control"  value="<?php echo($result->tandatevente1) ;?>">
                                        
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group" style="margin-right:15px">
                                        <label>تاريخ البيع  3 </label>
                                    <input type="date" name="tandatevente2" class="form-control"  value="<?php echo($result->tandatevente2) ;?>">
                            ...
                            <div class="col-md-3" >
                                <div class="form-group" style="margin-left:15px">
                                        <label>تاريخ البيع  4 </label>
                                    <input type="date" name="tandatevente3" class="form-control"  value="<?php echo($result->tandatevente3) ;?>">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group" style="margin-right:15px">
                                        <label>نوع المحضر  </label>
                                        <input type="text" name="tangenrepv4" class="form-control">
                                    </div>
                                    <div class="form-group" style="margin-right:15px">

                                        <label>تعيين تاريخ  جديد للبيع </label>
                                    <input type="date" name="tandatevente5" class="form-control" >
                                ...
                                <input type="date" name="tandatepvvente4" class="form-control">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="tanreqpvvente4" class="form-control" rows="2"></textarea>
...
$tandatepvvente4 = strtotime($_POST['tandatepvvente4']);
$new_date4 = date('Y-m-d', $tandatepvvente4);
$tandatevente5 = strtotime($_POST['tandatevente5']);
$new_date5 = date('Y-m-d', $tandatevente5);
$tangenrepv4 = $_POST['tangenrepv4'];
$tanreqpvvente4 = $_POST['tanreqpvvente4'];

$sql = "UPDATE tanfid SET tandatepvvente4 = '$new_date4', tandatevente5 = '$new_date5', tangenrepv4 = '$tangenrepv4', tanreqpvvente4 = '$tanreqpvvente4'  WHERE idtan='$idtan'";
   
   if (mysqli_query($conn, $sql)) {
        
     header('Location: tanlistevente5.php');
   } else {
