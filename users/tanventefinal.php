                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group" style="margin-right:15px">
                                        <label>نوع المحضر  </label>
                                        <input type="text" name="tangenrepv" class="form-control" value="<?php echo($result->tangenrepv) ;?>">
                                ...
                                <input type="date" name="tandatepvvente" class="form-control" value="<?php echo($result->tandatepvvente) ;?>">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="tanreqpvvente" class="form-control" rows="2" value="<?php echo($result->tanreqpvvente) ;?>"><?php echo($result->tanreqpvvente) ;?></textarea>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group" style="margin-right:15px">
                                        <label>نوع المحضر  </label>
                                        <input type="text" name="tanpv" class="form-control">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group" style="margin-left:15px">
                                        <label>مضمون  المحضر  </label>
                                    <textarea name="tanreqpv" class="form-control" rows="2"></textarea>
