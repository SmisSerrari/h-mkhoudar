                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group" style="margin-right:15px">
                                        <label>نوع المحضر  </label>
                                        <input type="text" name="tangerepvfinal" class="form-control">
                                ...
                                <input type="date" name="tandatepvfinal" class="form-control">
                                        
                                </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group" style="margin-left:15px">
                                        <label>الملاحظة النهائية للتنفيذ </label>
                                    <textarea name="tanreqpvfinal" class="form-control" rows="2"></textarea>
...
$tandatevente = strtotime($_POST['tandatevente']);
$new_date = date('Y-m-d', $tandatevente);
$tanmodelG = $_POST['tanmodelG'];

$sql = "UPDATE tanfid SET tandatevente = '$new_date', tanmodelG=1  WHERE idtan='$idtan'";
   
   if (mysqli_query($conn, $sql)) {
        
     header('Location: tanlistevente.php');
   } else {
