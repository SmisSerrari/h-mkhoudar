                    ...
                    <div class="panel panel-default">
                        ...
                        { 
                           ...
                           if($val['tanmodelG']==1){
                            ...
                            echo "لا ";echo '</td>'; }
                           echo '<td>';
                           echo $val['tandatevente'];echo '</td>';
                           echo '<td>';
                           echo $val['tangenrepv'];echo '</td>';
                           echo '<td>';
                           echo $val['tandatepvvente'];echo '</td>';
                           echo '<td>';
                           echo $val['tanreqpvvente'];echo '</td>';
                           echo '<td>';
                           echo $val['tandatevente1'];echo '</td>';
                           echo '<td>';
                           echo $val['tangenrepv1'];echo '</td>';
                           echo '<td>';
                           echo $val['tandatepvvente1'];echo '</td>';
                           echo '<td>';
                           echo $val['tanreqpvvente1'];echo '</td>';
                           echo '<td>';
                           echo $val['tandatevente2'];echo '</td>';
                           echo '<td>';
                           echo (
                             "<div class=\"btn btn-success btn-outline\" align=\"center\" ><a href=\"tanoperavente.php?idtan=".$val['idtan']."\"> حضور المتزيدين   </a></div>\n
                             <div class=\"btn btn-warning btn-outline\" align=\"center\" ><a href=\"tanoperaventeno2.php?idtan=".$val['idtan']."\"> عدم حضور المتزايددين   </a></div>
                             <div class=\"btn btn-warning btn-outline\" align=\"center\" ><a href=\"tanoperaventeno2.php?idtan=".$val['idtan']."\"> إعاداة البيع </a></div>
