...
$sql = "SELECT * FROM moukhtalif WHERE monjaz = 1 ORDER BY UNIX_TIMESTAMP(num_monjaz) DESC LIMIT ".$counter."";
...
<body  style="font-family:tahoma;">
    ...
    <div id="wrapper">
       ...
       <div id="page-wrapper">
       <form method="post" action="mokhrecu_pdf.php?counter=<?php echo $counter ?>" target="_blank">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> الاجراءات المنجزة و جاهزة للإرسال </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<?php 
    ...
    while($val = $result->fetch_assoc())
    {
        ...
        echo "<tr>";
                           ...
                           echo '<td>'; echo $val['mkhtanhuis'];echo '</td>';
