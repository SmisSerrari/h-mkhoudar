...
if(!empty($_POST['irsal'])) {
 ...
 ?>
       ...
       <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> ملفات  الحجز التنفذي</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>النائب عنه</th>
                                            <th> المنفذ عليه </th>
                                            <th> المفوض  القضائي المنفذ </th>                       
                                            <th>نوع المحضر  </th>
                                            <th>الملاحظة النهائية  </th>
                        ...
                        { 
						   ...
						   echo '<td>';
                           echo ("<div class=\"btn btn-default\" align=\"center\" ><a href=\"tanpvhajztan.php?idtan=".$val['idtan']."\">تبليغ محضر  الحجز </a></div>\n") ;
                           echo '</td>'; 
    					   echo "</tr>"; 
						  }
						   ?>
