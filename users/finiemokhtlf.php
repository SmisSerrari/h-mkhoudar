...
<body  style="font-family:tahoma;">
    ...
    <div id="wrapper">
       ...
       <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">الاجراءات الواردة</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        // requête
                        $query = 'SELECT * FROM moukhtalif WHERE encour=1';
                        ...
                        { 
                           echo '<tr>';
						   echo '<td>';   echo $val['idmkh'];echo '</td>';
						   ...
						   echo '<td>';
                           echo (
                             "<div class=\"btn btn-default\" align=\"center\" ><a href=\"tadminmokhtalif.php?idmkh=".$val['idmkh']."\"> تضمين</a></div>\n") ;
                           echo '</td>';                                    
