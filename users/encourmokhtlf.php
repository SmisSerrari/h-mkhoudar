...
<meta charset="utf-8">
    ...
    <title>المفوض القضائي - تنفيذ مختليف طور الانجاز </title>
...
<body  style="font-family:tahoma;">
    ...
    <div id="wrapper">
       ...
       <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> طور الانجاز  </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="col-lg-2">  
                            ...
                            <label>الكاتب المحلف</label>
                              <select class="form-control" name="mkhclerc" id="table-filter">
                                            <option></option>
                                            <?php 
                        ...
                        $NbrCol = 100000;
                        // requête
                        $query = 'SELECT * FROM moukhtalif WHERE donne=1 AND encour=0';
                        ...
                        { 
						  echo '<tr class="success">';
                           ...
                           echo '<td>';   echo $val['mkhregGen'];echo '</td>';
                           echo '<td>';   echo $val['mkhregPre'];echo '</td>';
						   echo '<td>';   echo $val['mkhtribunal'];echo '</td>';
                           echo '<td>'; echo $val['mkhgenre'];echo '</td>';
                           echo '<td>'; echo $val['mkhnumtan'];echo '</td>';
                           echo '<td>'; echo $val['mkhnumdoss'];echo '</td>';
                           echo '<td>'; echo $val['mkhnumh'];echo '</td>';
                           echo '<td>'; echo $val['mkhdatee'];echo '</td>';
                           echo '<td>'; echo $val['mkhavec'];echo '</td>';
                           echo '<td>'; echo $val['mkhavoca'];echo '</td>';
                           echo '<td>'; echo $val['mkhcontre'];echo '</td>';
                           echo '<td>'; echo $val['mkhadress'];echo '</td>';
                           echo '<td>'; echo $val['mkhhuiss'];echo '</td>';
						   echo '<td>'; echo $val['mkhclerc'];echo '</td>';
                           echo '<td>'; echo $val['num_donne'];echo '</td>';
						   echo '<td>';
						   echo '<input type="checkbox" name="encour[]" value="'.$val['idmkh'].'"/>';echo '</td>';
...
if(isset($_POST['envoyer']))
    {
 if(!empty($_POST['encour'])) {
    $counter = 0;

        foreach($_POST['encour'] as $value){
        $counter = $counter+1;
       
    
            $query = "UPDATE moukhtalif SET encour=1 WHERE idmkh = $value";
            mysqli_query($conn,$query);
            $query2 = "UPDATE moukhtalif SET num_encour=NOW() WHERE idmkh = $value";
            mysqli_query($conn,$query2);
              
        }
        $num_encour =  $num_encour + 1;
          header('Location: mokhencour.php?counter='.$counter.'');
