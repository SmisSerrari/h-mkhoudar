                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group" style="margin-right:15px">
                                        <label>نوع المحضر  </label>
                                        <input type="text" name="tangenrepv1" class="form-control">
                                    </div>
                                    <div class="form-group" style="margin-right:15px">

                                        <label>تعيين تاريخ  جديد للبيع </label>
                                    <input type="date" name="tandatevente2" class="form-control" >
                                ...
                                <input type="date" name="tandatepvvente1" class="form-control">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="tanreqpvvente1" class="form-control" rows="2"></textarea>
...
$tandatepvvente1 = strtotime($_POST['tandatepvvente1']);
$new_date1 = date('Y-m-d', $tandatepvvente1);
$tandatevente2 = strtotime($_POST['tandatevente2']);
$new_date2 = date('Y-m-d', $tandatevente2);
$tangenrepv1 = $_POST['tangenrepv1'];
$tanreqpvvente1 = $_POST['tanreqpvvente1'];

$sql = "UPDATE tanfid SET tandatepvvente1 = '$new_date1', tandatevente2 = '$new_date2', tangenrepv1 = '$tangenrepv1', tanreqpvvente1 = '$tanreqpvvente1'  WHERE idtan='$idtan'";
   
   if (mysqli_query($conn, $sql)) {
        
     header('Location: tanlistevente2.php');
   } else {
