...
if(!empty($_POST['monjaz'])) {
    $counter = 0;
        ...
        $counter = $counter+1;
            ...
            $query = "UPDATE moukhtalif SET monjaz=1 WHERE idmkh = $value";
            mysqli_query($conn,$query);
            $query2 = "UPDATE moukhtalif SET num_monjaz=NOW() WHERE idmkh = $value";
            mysqli_query($conn,$query2);
              
        }
        $num_taslim =  $num_taslim + 1;
          header('Location: encourmokhrecu.php?counter='.$counter.'');
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<li><a href="#"><i class="fa fa-wrench fa-briefcase"></i>+ التنفيذ المختلف  <span class="fa arrow"></span></a>
                                	<ul class="nav nav-second-level">
                                		<li>
                                    <a href="enregistremokhtalif.php">- تسجيل ملفات التنفيذ المختلف </a>
                                </li>
								<li>
						...
						<li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<li>
                                    <a href="listkabaikhbari.php">لائحة المحضر الاخبارية</a>
                                </li>
								<li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>المفةض المنفذ </th>
											<th>تاريخ التنفيذ </th>
                                            <th width="20%">مأل ملف التنفيذ </th>
											<th>تاريخ النهائي للتنفيذ </th>
                                            <th>المآل النهائي للملف </th>
                                            <th>اختيارات</th>
                                        </tr>
                                    </thead>
						...
						$NbrCol = 10000;
                        // requête
                        $query = 'SELECT * FROM moukhtalif WHERE encour=1 AND mkhdatet!=0 AND mkhdatefin!=0';
                        ...
                        { 
						   ...
						   echo '<td>';   echo $val['mkhref'];echo '</td>';
                           ...
                           echo '<td>';
                           echo $val['mkhtanhuis'];echo '</td>';
                           echo '<td>';
                           echo $val['mkhdatetan'];echo '</td>';
                           echo '<td>';
                           echo $val['mkhreqecrtan'];echo '</td>'; 
						   echo '<td>';
                           echo $val['mkhdatefin'];echo '</td>';
						   echo '<td>';
                           echo $val['mkhreqecrfin'];echo '</td>'; 
						   echo '<td>';
						   echo '<input type="checkbox" name="monjaz[]" value="'.$val['idmkh'].'"/>';echo '</td>';
    							     echo "</tr>"; 
							        }
						           ?>
