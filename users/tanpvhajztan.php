                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="date" name="tanpvdatehajz" class="form-control">
                            ...
                            <div class="col-md-6">
                                    <div class="form-group" style="margin-left:15px">
                                            <label>ملاحظة الحجز التنفيذي</label>
                                            <textarea class="form-control" rows="2" name="tanreqpvhajz"></textarea>
                                        </div>
                                    </div>
                            </div>                  
...
$tanpvdatehajz = strtotime($_POST['tanpvdatehajz']);
$new_date = date('Y-m-d', $tanpvdatehajz);
$tanreqpvhajz = $_POST['tanreqpvhajz'];

$sql = "UPDATE tanfid SET tanpvdatehajz = '$new_date', tanreqpvhajz = '$tanreqpvhajz' WHERE idtan='$idtan'";
   
   if (mysqli_query($conn, $sql)) {
        
     header('Location: tanlistepvhajztan.php');
   } else {
