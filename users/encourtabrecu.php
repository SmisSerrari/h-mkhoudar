...
<body  style="font-family:tahoma;">
    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
								...
								<li>
                                    <a href="modiftan.php"> تعديل الملف </a>
                                </li>
								<li>
						...
						<li>
                            ...
                            <ul class="nav nav-second-level">
                                 <li>
                                    <a href="enregistrekabada.php"> الاجراءات التراتيبة </a>
                                </li>
                                ...
                                <li>
                                    <a href="monjazkabada.php"> الاجراءات المنجزة </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="demlistekabada.php">   طلب قائمة الحجز   </a>
                                </li>
								<li>
                                    <a href="datelistkabada.php"> تاريخ تسلم القائمة </a>
                                </li>
								<li>
                                    <a href="hajzkabada.php"> تاريخ إنجاز الحجز </a>
                                </li>
								...
								<li>
                                    <a href="savetan.php"> ارشيف الخزينة العامة </a>
                                </li>
       ...
       <div id="page-wrapper">
       <form method="post" action="tabrecu_pdf.php?counter=<?php echo $counter ?>" target="_blank">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> الاجراءات المكنجزة و جاهزة للإرسال </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
?>
                                ...
                                <button class="btn-default"><a href="savetab.php"> الحفظ   </a></button>
