...
<meta charset="utf-8">
    ...
    <title>المفوض القضائي - طور  الانجاز </title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        $NbrCol = 100000;
                        // requête
                        $query = 'SELECT * FROM tanfid WHERE donne=1 AND encour=0';
                        $result = mysqli_query($conn,$query);;
                        // -------------------------------------------------------      
                        ...
                        { 
						   ...
						   echo '<td>';
						   echo '<input type="checkbox" name="encour[]" value="'.$val['idtan'].'"/>';echo '</td>';
 ...
 if(!empty($_POST['encour'])) {
    $counter = 0;
        ...
        $counter = $counter+1;
            ...
            $query = "UPDATE tanfid SET encour=1 WHERE idtan = $value";
            mysqli_query($conn,$query);
            $query2 = "UPDATE tanfid SET num_encour=NOW() WHERE idtan = $value";
            mysqli_query($conn,$query2);
              
        }
        $num_donne =  $num_donne + 1;
          header('Location: tanencouren.php?counter='.$counter.'');
