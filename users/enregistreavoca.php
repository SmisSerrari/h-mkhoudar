...
<head>
    ...
    <title>المفوض القضائي - تسجيل  محامي</title>
...
<body style="font-family:tahoma;">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">تسجيل  محامي</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
							        ...
							        <div class="form-group" style="margin-bottom:15px">
                                        <label>  الاسم  و النسب للأستاذ    </label>
                                        <input class="form-control" type="text" placeholder=" الاسم  و النسب للأستاذ  " name="anom">
                                    </div>
                                    <div class="form-group" style="margin-bottom:15px">
                                            <label>تاريخ  التسجيل </label>
                                            <input class="form-control" type="date" placeholder="تاريخ  التسجيل " name="adate">
                                    </div>
...
$query = "INSERT INTO avocas ( anom, adate )
            VALUES ( '$anom' , '$adate') ";

   if (mysqli_query($conn, $query)) {
      echo '<center> تمت إضافة  الاستاد(ة) '.$anom.'<center>';
