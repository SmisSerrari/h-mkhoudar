...
<body  style="font-family:tahoma;">
    ...
    <div id="wrapper">
       ...
       <div id="page-wrapper">
       <form method="post" action="mokhencour_pdf.php?counter=<?php echo $counter ?>" target="_blank">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">تنفيذات طور الانجاز</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        $NbrCol = 100000;
                        // requête
                        $query = 'SELECT * FROM moukhtalif WHERE donne=1 AND encour=1';
