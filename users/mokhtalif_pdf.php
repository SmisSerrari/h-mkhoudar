...
$tbl = "<h1 align=\"centre\"><b> مكتب المفوض القضائي  الاستاذ مراد خضار </b></h1>
		...
		<hr><br><h2>تنفيذ قصد الانجاز  </h2><br><h3> عدد الاجراءات : ".$counter."</h3>";
...
<thead>
    <tr>
        ...
        <th align="center" width="130">العنوان</th>                                        
...
while($val = $result->fetch_assoc())
    {
$tbl .= "<tr>";
$tbl .= "<td width=\"40\" align=\"center\"> ".$val["mregGen"]." </td>"; 
$tbl .= "<td width=\"60\" align=\"center\"> ".$val["mtrubunal"]." </td>";
$tbl .= "<td width=\"60\" align=\"center\"> ".$val["mgenre"]." </td>";
$tbl .= "<td width=\"70\" align=\"center\"> ".$val["mnumtan"]." </td>"; 
$tbl .= "<td width=\"90\" align=\"center\"> ".$val["mavec"]." </td>";  
$tbl .= "<td width=\"90\" align=\"center\"> ".$val["mcontre"]." </td>";
$tbl .= "<td width=\"130\" align=\"center\"> ".$val["madress"]." </td>";
...
$tcpdf->SetTitle('تنفيذ قصد الانجاز');
