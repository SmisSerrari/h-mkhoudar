...
$tbl .= "<td width=\"60\" align=\"center\"> ".$val["mkhgenre"]." </td>";
$tbl .= "<td width=\"60\" align=\"center\"> ".$val["mkhnumtan"]." </td>"; 
$tbl .= "<td width=\"85\" align=\"center\"> ".$val["mkhavec"]." </td>";  
$tbl .= "<td width=\"85\" align=\"center\"> ".$val["mkhcontre"]." </td>";
$tbl .= "<td width=\"75\" align=\"center\"> ".$val["mkhtanhuis"]." </td>";
$tbl .= "<td width=\"85\" align=\"center\"> ".$val["mkhreqecrfin"]." </td>"; 
$tbl .= "<td width=\"75\" align=\"center\"> ".$val["mkhdatefin"]." </td>";
