            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>المفوض المنفذ </th>
											<th>تاريخ التنفيذ </th>
                                            <th width="40%">مأل ملف التنفيذ </th>
						...
						$NbrCol = 10000;
                        // requête
                        $query = 'SELECT * FROM moukhtalif WHERE encour=1 AND mkhdatet!=0 AND mkhdatetan!=0';
                        ...
                        { 
						   ...
						   echo '<td>';
                           echo (
                             "<div class=\"btn btn-default\" align=\"center\" ><a href=\"fintanfidmokhtalif.php?idmkh=".$val['idmkh']."\"> المآل النهائي للملف </a></div>\n") ;
                           echo '</td>';
    							     echo "</tr>"; 
							        }
						           ?>
