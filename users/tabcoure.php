...
$sql = "SELECT * FROM tabligh WHERE encour = 1 ORDER BY UNIX_TIMESTAMP(num_encour) DESC LIMIT ".$counter."";
...
<body  style="font-family:tahoma;">
    ...
    <div id="wrapper">
       ...
       <div id="page-wrapper">
       <form method="post" action="tablighcour_pdf.php?counter=<?php echo $counter ?>" target="_blank">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">طبع اجراءات طور النجاز </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
?>
                                ...
                                <button class="btn-default"><a href="finietab.php"> الاجراءات المنجزة </a></button>
