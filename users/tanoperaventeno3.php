                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group" style="margin-right:15px">
                                        <label>نوع المحضر  </label>
                                        <input type="text" name="tangenrepv3" class="form-control">
                                    </div>
                                    <div class="form-group" style="margin-right:15px">

                                        <label>تعيين تاريخ  جديد للبيع </label>
                                    <input type="date" name="tandatevente4" class="form-control" >
                                ...
                                <input type="date" name="tandatepvvente3" class="form-control">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="tanreqpvvente3" class="form-control" rows="2"></textarea>
...
$tandatepvvente3 = strtotime($_POST['tandatepvvente3']);
$new_date3 = date('Y-m-d', $tandatepvvente3);
$tandatevente4 = strtotime($_POST['tandatevente4']);
$new_date4 = date('Y-m-d', $tandatevente4);
$tangenrepv3 = $_POST['tangenrepv3'];
$tanreqpvvente3 = $_POST['tanreqpvvente3'];

$sql = "UPDATE tanfid SET tandatepvvente3 = '$new_date3', tandatevente4 = '$new_date4', tangenrepv3 = '$tangenrepv3', tanreqpvvente3 = '$tanreqpvvente3'  WHERE idtan='$idtan'";
   
   if (mysqli_query($conn, $sql)) {
        
     header('Location: tanlistevente4.php');
   } else {
