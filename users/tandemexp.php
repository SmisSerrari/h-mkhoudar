                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-3" >
                                ...
                                <input type="date" name="tandatedem" class="form-control">
...
$tandatedem = strtotime($_POST['tandatedem']);
$new_date = date('Y-m-d', $tandatedem);


$sql = "UPDATE tanfid SET tandatedem = '$new_date' WHERE idtan='$idtan'";
   
   if (mysqli_query($conn, $sql)) {
        
     header('Location: tanlisterapexp.php');
   } else {
