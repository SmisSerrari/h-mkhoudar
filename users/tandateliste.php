...
if(!empty($_POST['irsal'])) {
 ...
 ?>
       ...
       <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">  المنجزة قصد الارسال</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						$NbrCol = 10000;
                        // requête
                        $query = 'SELECT * FROM tanfid WHERE encour=1 AND irsal=0 AND tandatepv!=0';
                        ...
                        { 
						   ...
						   echo '<td>';
						   echo'<input type="checkbox" name="irsal[]" value="'.$val['idtan'].'"/>';
						   echo '</td>';
    							     echo "</tr>"; 
							        }
						           ?>
