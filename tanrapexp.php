                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-3" >
                             ...
                             <div class="col-md-3" >
                                ...
                                <input type="date" name="tandaterap" class="form-control">
...
$tandaterap = strtotime($_POST['tandaterap']);
$new_date = date('Y-m-d', $tandaterap);


$sql = "UPDATE tanfid SET tandaterap = '$new_date' WHERE idtan='$idtan'";
   
   if (mysqli_query($conn, $sql)) {
        
     header('Location: tanlisteexp.php');
   } else {
