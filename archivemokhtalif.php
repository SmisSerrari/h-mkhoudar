            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        // requête
                        $query = 'SELECT * FROM tablighat,document WHERE monjaz=1 AND tablighat.idtab = document.idupt';
                        ...
                        while($val = $result->fetch_assoc())
                        {
						   ...
						   echo '<td>';
						   echo $val['trubunal'];echo '</td>';
						   echo '<td>';
						   echo $val['genre'];echo '</td>';
						   echo '<td>';
						   echo $val['numdoss'];echo '</td>';
						   echo '<td>';
						   echo $val['avec'];echo '</td>';
						   echo '<td>';
						   echo $val['avoca'];echo '</td>';
						   echo '<td>';
						   echo $val['contre'];echo '</td>';
						   echo '<td>';
						   echo $val['adress'];echo '</td>';
						   echo '<td>';
						   echo $val['clerc'];echo '</td>';
						   echo '<td>';
						   echo $val['datetabligh'];echo '</td>';
						   echo '<td>';
                           echo $val['reqGen'];echo '</td>';
                           echo '<td>';
                           echo $val['reqEcr'];echo '</td>';
                            echo '<td>';
                           echo $val['name'].' : '.'<a href="'.$val['fichier_url'].'">Telecharger: '.$val['name'].'</a><br/>';
                            echo '</td>';
