                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>أحل التبليغ</label>
                                        <input class="form-control" type="hour"  name="heureret">
                                           <!-- <select name="heureret" required class="form-control">
                                                <option></option>
                                                <option value="24 hour">24 ساعة</option>
                                                <option value="48 hour">48 ساعة</option>
                                                <option value="72 hour">72 ساعة</option>
                                                <option value="96 hour">96 ساعة</option>
                                                <option value="120 hour">120 ساعة</option>
                                            </select>-->
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" placeholder="2019/02/20" name="tabdateentre">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
...
if(isset($_POST["submit"]))
{
    ...
    $tabdateentre = validedonnes($_POST["tabdateentre"]);
    ...
    $heureret = validedonnes($_POST["heureret"]);


$query = "INSERT INTO tabligh ( tabtrubunal,tabregGen,tabregPre,tabdateentre, tabnumdoss, tabnumtanfid,tabgenre,heureret, tabavec, tabavoca, tabcontre, tabadress, tabsource, tabclerc, tabdatejalsa, tabhuis )
            VALUES ( '$tabtrubunal' , '$tabregGen' , '$tabregPre' ,'$tabdateentre', '$tabnumdoss' ,'$tabnumtanfid' , '$tabgenre', '$heureret', '$tabavec' , '$tabavoca' , '$tabcontre', '$tabadress', '$tabsource', '$tabclerc', '$tabdatejalsa','$tabhuis') ";
