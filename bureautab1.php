...
<meta charset="utf-8">
    ...
    <title>المفوض القضائي - قصد الانجاز </title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						<?php
                        $query = 'SELECT COUNT(*), tabregGen, tabregPre, tabtrubunal, tabgenre, tabnumdoss, tabdatejalsa, tabavec, tabavoca, tabcontre, tabadress, tabclerc FROM tabligh GROUP BY tabregGen HAVING COUNT(*) > 1';
                        $result = mysqli_query($conn,$query);;
...
<?php 
 ...
 ?>
 <!--$query2 = ('DELETE t1 FROM tabligh AS t1, tabligh AS t2 WHERE t1.idtab > t2.idtab 
                        AND t1.tabregGen = t2.tabregGen 
                        AND t1.tabregPre = t2.tabregPre
                        AND t1.tabgenre = t2.tabgenre 
                        AND t1.tabnumdoss = t2.tabnumdoss 
                        AND t1.tabdatejalsa = t2.tabdatejalsa 
                        AND t1.tabavec = t2.tabavec 
                        AND t1.tabavoca = t2.tabavoca 
                        AND t1.tabcontre = t2.tabcontre 
                        AND t1.tabadress = t2.tabadress 
                        AND t1.tabadress = t2.tabadress 
                        AND t1.tabclerc = t2.tabclerc');
                        $result2 = mysqli_query($conn, $query2);-->
<!-- tabregPre, tabtrubunal, tabgenre, tabnumdoss, tabdatejalsa, tabavec, tabavoca, tabcontre, tabadress, tabclerc-->