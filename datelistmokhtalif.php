            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						$NbrCol = 10000;
                        // requête
                        $query = 'SELECT * FROM mokhtalif WHERE encour=1 AND mdatetab!=0';
                        ...
                        { 
						   ...
						   echo $val['mregGen'];echo '</td>';
                           echo '<td>';
                           echo $val['mregPre'];echo '</td>';
                           echo '<td>';
                           echo $val['mtrubunal'];echo '</td>';
                           echo '<td>';
                           echo $val['mgenre'];echo '</td>';
                           echo '<td>';
                           echo $val['mnumdoss'];echo '</td>';
                           echo '<td>';
                           echo $val['mavec'];echo '</td>';
                           echo '<td>';
                           echo $val['mavoca'];echo '</td>';
                           echo '<td>';
                           echo $val['mcontre'];echo '</td>';
                           echo '<td>';
                           echo $val['num_donne'];echo '</td>';
                           echo '<td>';
                           echo $val['num_encour'];echo '</td>';
                           echo '<td>';
                           echo $val['mdatetab'];echo '</td>';
                           echo '<td>';
                           echo $val['mreqgen'];echo '</td>';
                           echo '<td>';
                           echo $val['mreqecr'];echo '</td>';
						   echo '<td>';
                           echo (
                             "<div class=\"btn btn-default\" align=\"center\" ><a href=\"tanfidmokhtalif.php?idm=".$val['idm']."\"> طور التنفيذ </a></div>\n") ;
                           echo '</td>';
    							     echo "</tr>"; 
							        }
						           ?>
