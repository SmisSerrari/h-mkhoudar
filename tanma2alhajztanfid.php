                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                        <div class="form-group" style="margin-right:15px">
                                            ...
                                            <select class="form-control" name="tanpv">
                                                ...
                                                <option value="حجز تنفيذي">  حجز تنفيذي</option>
                                        ...
                                        <div class="form-group" style="margin-right:15px">
                                            <label>المفوض القضائي</label>
                                            <select class="form-control" name="tanhuistan">
                                            <option>المفوض القضائي</option>
                                            <?php 
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="date" name="tandatepvhajz" class="form-control">
...
$tandatepvhajz = strtotime($_POST['tandatepvhajz']);
$tanpv = $_POST['tanpv'];
$new_date = date('Y-m-d', $tandatepvhajz);
$tanreqpv = $_POST['tanreqpv'];
$tanhuistan = $_POST['tanhuistan'];


$sql = "UPDATE tanfid SET tandatepvhajz = '$new_date', tanpv = '$tanpv', tanreqpv = '$tanreqpv', tanhuistan = '$tanhuistan' WHERE idtan='$idtan'";
   
   if (mysqli_query($conn, $sql)) {
        
     header('Location: tanhajztan.php');
   } else {
