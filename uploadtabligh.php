 ...
 if(!empty($_FILES))
    {
        ...
        $files_dest =  'documents/'.$file_name;
        ...
        if(in_array($file_extension, $extension_autorisees))
        {
            if (move_uploaded_file($file_tmp_name, $files_dest))
                {
                    $idup = $_POST["idup"];
                $req = "INSERT INTO document(idup, name, fichier_url) VAlUES ('$idup','$file_name','$files_dest')";
                    mysqli_query($conn, $req);
                    echo "<center>تم ذمج الوثيقة بنجاح   </center>";
            }else{
                    echo "une erreur est suvenue";
            }
        }
        else{

            echo "l'extenssion de ce fichier n'est pas autorisees"; 
        }
}
?>
...
<body style="font-family:tahoma;">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> ذمج الوثيقة  </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			...
			<div class="col-lg-6">
				...
				<form role="form" name="upload_file"  method="POST" enctype="multipart/form-data">
                          ...
                          <div class="row">
                            <div class="col-md-4">
								<div class="form-group">
                                    <label>مرجع </label>
                                    <input class="form-control" placeholder="مرجع " name="idup">
							...
							<div class="col-lg-6">
                                ...
                                <input type="submit" name="submit" class="btn btn-outline btn-success btn-lg" style="margin:15px; width:50%" value="ذمج الوثيقة ">
