                        ...
                        <div class="panel-body">
							...
							<div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="date" name="tandatetabligh" class="form-control">
                            ...
                            <div class="col-md-6">
									<div class="form-group" style="margin-left:15px">
                                            ...
                                            <textarea class="form-control" rows="2" name="tanreqEcr" ></textarea>
                                        </div>
									</div>
                            </div>					
...
$tandatetabligh = strtotime($_POST['tandatetabligh']);
$tanreqGen = $_POST['tanreqGen'];
$new_date = date('Y-m-d', $tandatetabligh);
$tanreqEcr = $_POST['tanreqEcr'];

$sql = "UPDATE tanfid SET tandatetabligh = '$new_date', tanreqGen = '$tanreqGen', tanreqEcr = '$tanreqEcr' WHERE idtan='$idtan'";
   
   if (mysqli_query($conn, $sql)) {
        echo $tandatetabligh; echo "<br> $tanreqEcr"; echo "<br> $tanreqGen";
     header('Location: tanfine.php');
   } else {
