...
<body  style="font-family:tahoma;">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li><a href="tanrecherche.php">-  التبليغ</a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="enregistretan.php"> تسجيل الاجراءات </a>
                                </li>
                <li>
                                    <a href="uploadtanligh.php"> ذمج الوثيقة  </a>
                                </li>
                <li>
                ...
                <li>
                                ...
                                <li>
                                    <a href="datelisttanligh.php"> منجزة قصد  الارسال </a>
                                </li>
                <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="archivetanligh.php"> التبليغ </a>
                                </li>
       ...
       <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">البحث عن التنفيذات </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        { 
                                  ...
                                  echo '</tr>';
                                    ...
                                    if ($val['donne'] == 1 && $val['encour'] == 0 && $val['tandatetabligh'] == "" && $val['tanreqGen'] == "" && $val['tanreqEcr'] == ""){
                                ...
                                if ($val['encour'] == 1 && $val['tandatetabligh'] == "" && $val['tanreqGen'] == "" && $val['tanreqEcr'] == ""){
                                ...
                                if ($val['encour'] == 1 && $val['tandatetabligh'] != "" && $val['tanreqGen'] != "" && $val['tanreqEcr'] != "" && $val['monjaz'] == 0){
                                   ...
                                   echo '<td>';
                                   echo $val['tandatejalsa'];echo '</td>';
                                   echo '<td>';
                                   echo $val['num_donne'];echo '</td>';
                                   echo '<td>';
                                   echo $val['num_encour'];echo '</td>';
                                   echo '<td>';
                                   echo $val['tandatetanligh'];echo '</td>';
                                   echo '<td>';
                                   echo $val['tanreqGen'];echo '</td>';
                                   echo '<td>';
                                   echo $val['tanreqEcr'];echo '</td>'; 
                                  ...
                                  echo '</tr>';
                                    ...
                                    if ($val['encour'] == 1 && $val['tandatetabligh'] != "" && $val['tanreqGen'] != "" && $val['tanreqEcr'] != "" && $val['num_monjaz'] != ""){
                                   echo '<tr>';
    ...
    <!-- Datatanles JavaScript -->
    <script src="js/jquery/jquery.datatanles.min.js"></script>
    <script src="js/bootstrap/datatanles.bootstrap.min.js"></script>

    <!-- Custom Theme JavaScript -->
    <script src="js/sb-admin-2.js"></script>

    <!-- Page-Level Demo Scripts - tanles - Use for reference -->
    <script>
        $(document).ready(function() {
          $('#datatables-example').datatanle();
        });
    </script>
