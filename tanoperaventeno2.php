                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group" style="margin-right:15px">
                                        <label>نوع المحضر  </label>
                                        <input type="text" name="tangenrepv2" class="form-control">
                                    </div>
                                    <div class="form-group" style="margin-right:15px">

                                        <label>تعيين تاريخ  جديد للبيع </label>
                                    <input type="date" name="tandatevente3" class="form-control" >
                                ...
                                <input type="date" name="tandatepvvente2" class="form-control">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="tanreqpvvente2" class="form-control" rows="2"></textarea>
...
$tandatepvvente2 = strtotime($_POST['tandatepvvente2']);
$new_date2 = date('Y-m-d', $tandatepvvente2);
$tandatevente3 = strtotime($_POST['tandatevente3']);
$new_date3 = date('Y-m-d', $tandatevente3);
$tangenrepv2 = $_POST['tangenrepv2'];
$tanreqpvvente2 = $_POST['tanreqpvvente2'];

$sql = "UPDATE tanfid SET tandatepvvente2 = '$new_date2', tandatevente3 = '$new_date3', tangenrepv2 = '$tangenrepv2', tanreqpvvente2 = '$tanreqpvvente2'  WHERE idtan='$idtan'";
   
   if (mysqli_query($conn, $sql)) {
        
     header('Location: tanlistevente3.php');
   } else {
